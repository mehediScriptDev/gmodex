  ...
  const videos = [
    {
      title: "Nationality",
      description:
        "Black 100% Authentic nationality documents available for purchase.",
      ...
      ratingsCount: 300,
      thumbnail:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZm4FhZi0FxSiNagQT0lqHqnE7aqOTlJ_0AQ&s",
    },
    {
      ...
      ratingsCount: 382,
      thumbnail:
        "https://d100i36hiycpc5.cloudfront.net/uploads/2022/08/10/bank_statement_2.jpg",
    },

    {
      ...
      ratingsCount: 300,
      thumbnail:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeXLt1jN4r17X19uoKru9cHmEXhme08Bi5R25bWE6jnUv0hX83_PsB9y6JDt9Sunono-s&usqp=CAU",
    },
    {
      title: "Utility Bills",
      description:
        "Black utility bills for water, electricity, and other services.",
      ...
      ratingsCount: 600,
      thumbnail:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6K9r79X-691G3LuSZbXfWZyOkj_tQRQHguA&s",
    },
  ];
  const guns = [
    {
    ...
    },
    {
      ...
      rating: 5,
      ratingsCount: 3000,
      thumbnail: "https://cdn.mos.cms.futurecdn.net/hSLnVL4CLBnx7xHzdFbCUM.jpg",
    },
  ];
